...
#
#     PHX_SERVER=true bin/journalex start
#
...
config :journalex, Journalex.Notion,
  ...
  trades_v1_data_source_id:
    System.get_env("NOTION_TRADES_V1_DATA_SOURCE_ID"),
  trades_v2_data_source_id:
...
if config_env() == :prod do
  ...
  config :journalex, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :journalex, Journalex.Mailer,
