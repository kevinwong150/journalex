defmodule JournalexWeb.Endpoint do
  use Phoenix.Endpoint, otp_app: :journalex
  ...
  if code_reloading? do
    ...
    plug Phoenix.Ecto.CheckRepoStatus, otp_app: :journalex
  end
